...
type FakeFlyExecuter struct {
	ExecuteStub        func(processor.Fly) error
...
func (fake *FakeFlyExecuter) Execute(arg1 processor.Fly) error {
...
func (fake *FakeFlyExecuter) ExecuteArgsForCall(i int) processor.Fly {
	fake.executeMutex.RLock()
	defer fake.executeMutex.RUnlock()
...
var _ processor.FlyExecuter = new(FakeFlyExecuter)
